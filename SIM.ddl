...
CREATE TABLE SIM_relation
  (
    relation_id            INTEGER NOT NULL ,
    SIM_project_project_id INTEGER NOT NULL ,
    SIM_Person_person_id   INTEGER NOT NULL
  ) ;
CREATE UNIQUE INDEX SIM_relation__IDX ON SIM_relation
  (
    SIM_project_project_id ASC
  )
  ;
CREATE UNIQUE INDEX SIM_relation__IDXv1 ON SIM_relation
  (
    SIM_Person_person_id ASC
  )
  ;
  ALTER TABLE SIM_relation ADD CONSTRAINT SIM_relation_PK PRIMARY KEY ( relation_id ) ;
...
ALTER TABLE SIM_relation ADD CONSTRAINT SIM_relation_SIM_Person_FK FOREIGN KEY ( SIM_Person_person_id ) REFERENCES SIM_Person ( person_id ) ;

ALTER TABLE SIM_relation ADD CONSTRAINT SIM_relation_SIM_project_FK FOREIGN KEY ( SIM_project_project_id ) REFERENCES SIM_project ( project_id ) ;
